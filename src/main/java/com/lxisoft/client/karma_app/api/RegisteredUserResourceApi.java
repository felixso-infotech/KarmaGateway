...
public interface RegisteredUserResourceApi {
    ...
    @ApiOperation(value = "getAllRegisteredUsers", nickname = "getAllRegisteredUsersUsingGET1", notes = "", response = RegisteredUserDTO.class, responseContainer = "List", tags={ "registered-user-resource", })
    @ApiResponses(value = { 
