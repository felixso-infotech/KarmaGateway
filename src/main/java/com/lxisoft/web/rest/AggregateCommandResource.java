...
import com.lxisoft.client.karma_app.api.AggregateCommandResourceApi;
...
public class AggregateCommandResource {
	...
	private final AggregateCommandResourceApi aggregateCommandResourceApi;

	private static final String ENTITY_NAME = "karmaApplicationAggregateCommandResource";

	public AggregateCommandResource(AggregateCommandResourceApi aggregateCommandResourceApi) {
	...
	public ResponseEntity<CompletedActivityModel> createCompletedActivity(
			@RequestBody CompletedActivityModel completedActivityModel) throws URISyntaxException, IOException {
		...
		if (completedActivityModel.getProofs() != null) {
			...
			for (MediaDTO mediaDTO : mediaDTOs) {
				...
				aggregateCommandResourceApi.createMediaUsingPOST(mediaDTO);
			}
		}
