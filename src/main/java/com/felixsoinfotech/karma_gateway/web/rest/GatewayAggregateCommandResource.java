...
public class GatewayAggregateCommandResource {
	...
	@Timed
	public ResponseEntity<CommittedActivityStatusAggregate> createCommittedActivity(
			@RequestBody CommittedActivityStatusAggregate committedActivityStatusAggregate) throws URISyntaxException {
		log.debug("&&&&&& date given ", committedActivityStatusAggregate.getCreatedDate());
	...
	@Timed
	public ResponseEntity<CommittedActivityStatusAggregate> updateCommittedActivity(
			@RequestBody CommittedActivityStatusAggregate committedActivityStatusAggregate) throws URISyntaxException {
