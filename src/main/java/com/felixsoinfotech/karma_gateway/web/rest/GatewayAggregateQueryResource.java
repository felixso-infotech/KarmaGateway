   ...
   /**
	 ...
	 */
     ...
     public ResponseEntity<List<ActivityAggregate>> getAllActivities(Pageable pageable) {
         ...
         List<ActivityAggregate> activityAggregateList = aggregateQueryResourceApi.getAllActivitiesUsingGET1(null, null, null, null, null, null, null, null, null, null).getBody();
         
         return ResponseEntity.ok().body(activityAggregateList);
     }
