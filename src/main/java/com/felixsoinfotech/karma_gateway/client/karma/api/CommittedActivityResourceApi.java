...
public interface CommittedActivityResourceApi {
    ...
    @ApiOperation(value = "createCommittedActivity", nickname = "createCommittedActivityUsingPOST1", notes = "", response = CommittedActivityDTO.class, tags={ "committed-activity-resource", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/api/committed-activities",
        produces = "*/*", 
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<CommittedActivityDTO> createCommittedActivityUsingPOST1(@ApiParam(value = "committedActivityDTO" ,required=true )  @Valid @RequestBody CommittedActivityDTO committedActivityDTO);


    @ApiOperation(value = "deleteCommittedActivity", nickname = "deleteCommittedActivityUsingDELETE", notes = "", tags={ "committed-activity-resource", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> deleteCommittedActivityUsingDELETE(@ApiParam(value = "id",required=true) @PathVariable("id") Long id);


    @ApiOperation(value = "getAllCommittedActivities", nickname = "getAllCommittedActivitiesUsingGET", notes = "", response = CommittedActivityDTO.class, responseContainer = "List", tags={ "committed-activity-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = CommittedActivityDTO.class, responseContainer = "List"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/committed-activities",
    ...
    ResponseEntity<CommittedActivityDTO> updateCommittedActivityUsingPUT1(@ApiParam(value = "committedActivityDTO" ,required=true )  @Valid @RequestBody CommittedActivityDTO committedActivityDTO);
