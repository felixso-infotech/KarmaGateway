...
public interface AggregateCommandResourceApi {
    ...
    @ApiOperation(value = "deleteComment", nickname = "deleteCommentUsingDELETE", notes = "", tags={ "aggregate-command-resource", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "deleteReply", nickname = "deleteReplyUsingDELETE", notes = "", tags={ "aggregate-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 204, message = "No Content"),
        @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @ApiOperation(value = "loveActivity", nickname = "loveActivityUsingPOST", notes = "", response = LoveDTO.class, tags={ "aggregate-command-resource", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "saveComment", nickname = "saveCommentUsingPOST", notes = "", response = CommentDTO.class, tags={ "aggregate-command-resource", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "saveReply", nickname = "saveReplyUsingPOST", notes = "", response = ReplyDTO.class, tags={ "aggregate-command-resource", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "unloveActivity", nickname = "unloveActivityUsingDELETE", notes = "", tags={ "aggregate-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 204, message = "No Content"),
        @ApiResponse(code = 401, message = "Unauthorized"),
